...
async function run() {
  console.log("=== STEP 1: Deleting ALL past_matches records between 2026-07-28 and 2026-07-29 ===");
  ...
  console.log(`Deleted ${delData.length} invalid/old records for July 28 & 29!`);

  console.log("\n=== STEP 2: Fetching official Mackolik Geniş İddaa Programı data ===");
  ...
  if (matchesToInsert.length > 0) {
    ...
    console.log(`Inserting ${uniqueMatches.length} clean Geniş İddaa matches...`);
  ...
  console.log("\n=== STEP 3: Verification of inserted database records ===");
  ...
  console.log(`Total clean rows for July 28 & 29 in past_matches: ${verifyData.length}`);
